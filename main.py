...
class SistemaDeRegistro:
    ...
    def view_all_students(self):
        ...
        for i in dados:
                print(f'''ID:{i[0]}, | Nome: {i[1]}, | Email: {i[2]}, | Tel: {i[3]}, | Sexo: {i[4]}, | Data_nascimento: {i[5]}, | Endereco: {i[6]}, | Curso: {i[7]}, | Picture: {i[8]}
                -----------------------------------------------------------------------------''') 

    def search_students(self, id):
        self.c.execute("SELECT * FROM students WHERE id = ?", (id,))
        dados = self.c.fetchone()
        print(f'''ID:{dados[0]}, | Nome: {dados[1]}, | Email: {dados[2]}, | Tel: {dados[3]}, | Sexo: {dados[4]}, |
    ...
    def update_students(self, new_value):
        ...
        self.conn.commit()
        messagebox.showinfo("Sucesso," f'Estudante com ID:{new_value[8]} foi atualizado!')
...
view_student = system_register.search_students(6)
